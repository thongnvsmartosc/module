...
class Interceptor extends \Magento\ImportExport\Controller\Adminhtml\Export\File\Delete implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\App\Action\Context $context, \Magento\Framework\Filesystem $filesystem, \Magento\Framework\Filesystem\DriverInterface $file, \Magento\Framework\Filesystem\Directory\WriteFactory $writeFactory)
    {
        $this->___init();
        parent::__construct($context, $filesystem, $file, $writeFactory);
    }
